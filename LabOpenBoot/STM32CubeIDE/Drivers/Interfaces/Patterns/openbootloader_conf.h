...
#define DEVICE_ID_LSB                     0x33U  /* LSB byte of device ID */

/* -------------------------- Definitions for Memories ---------------------- */
#define FLASH_MEM_SIZE                    (512U * 1024U)                  /* Size of Flash 0.5 MByte */
...
#define RAM_SIZE                          (96U * 1024U)                  /* Size of RAM 96 kByte */
...
#define OB_END_ADDRESS                    0x1FFFC00FU                /* Option bytes end address (128 bytes) */

#define OTP_START_ADDRESS                 0x1FFF7800U                   /* OTP registers address */
#define OTP_END_ADDRESS                   0x1FFF7A0FU                   /* OTP end address (1024 bytes) */

#define ICP1_START_ADDRESS                0x1FFF0000U                  /* System memory registers address */
#define ICP1_END_ADDRESS                  0x1FFF77FFU                  /* System memory registers end address */
